...
Here is an ingress gateway configuration.
...
You can confirm the ingress gateways have been configured as expected by looking at the Consul UI: [http://localhost:8500/ui/dc1/services/ingress-gateway/](http://localhost:8500/ui/dc1/services/ingress-gateway/).
