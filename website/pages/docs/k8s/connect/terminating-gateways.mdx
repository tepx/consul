...
```shell-session
$ consul acl token update -id 47b91c22-7c85-63c0-8c95-7e484b126835 -policy-name example-https-write-policy -merge-policies -merge-roles -merge-service-identities
```
